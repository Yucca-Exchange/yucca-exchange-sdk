...
describe.skip('data', () => {
  ...
  it('Pair', async () => {
    const token = new Token(ChainId.FUJICHAIN, '0xc7AD46e0b8a400Bb3C915120d284AafbA8fc4735', 18) // DAI
    const pair = await Fetcher.fetchPairData(WETH[ChainId.FUJICHAIN], token)
